...
def extract_fields():
    """ This generates tuples of commands, where:

    command, args

    Then these can be submitted to multiprocessing easily.
    ...
    for i in itr:
        ...
        for vrbl in vrbls:
            ...
            yield load_data, d02_nc_fpath, vrbl, npyfs
        ...
        if mem == 'm01':
            for vrbl in ("XLAT","XLONG"):
                ...
                yield load_data, d02_nc_fpath, vrbl, npyf
        ...
        for vrbl in vrbls:
            ...
            yield do_fcst_interp, d01_nc_fpath, vrbl, npyfs, d02lats, d02lons
